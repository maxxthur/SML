...
\[
\mathrm{E}\left[R_{t r}(\hat{\beta})\right] \leq \mathrm{E}\left[R_{t r}(\mathrm{E} \hat{\beta})\right]=\mathrm{E}\left[R_{t e}(\mathrm{E} \hat{\beta})\right] \leq \mathrm{E}\left[R_{t e}(\hat{\beta})\right]
\]
