...
# Display the results
cat("Misclassification Rate on Training Data for 'ao' class:", training_misclassification_rate, "\n")
cat("Log-Likelihood on Training Data for 'ao' class:", log_likelihood_training, "\n")
cat("Misclassification Rate on Test Data for 'ao' class:", test_misclassification_rate, "\n")
cat("Log-Likelihood on Test Data for 'ao' class:", log_likelihood_test, "\n")
